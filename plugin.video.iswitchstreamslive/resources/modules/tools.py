...
ADDONTITLE     = '[COLORffff0066][B][I]iSw!tch Streams[/I][/B][/COLOR][COLORfffefe33] .[/COLOR]'
...
def addDirMeta(name,url,mode,iconimage,fanart,description,year,cast,rating,runtime,genre):
	...
	liz.setProperty("IsPlayable","true")
	cm = []
	cm.append(('Play Trailer','XBMC.RunPlugin(plugin://plugin.video.iswitchstreamslive/?mode=9&url='+str(name)+')'))
...
def clear_cache():
	...
	dialog.ok(ADDONTITLE, "[COLORfffefe33]Cache Cleared Successfully![/COLOR]")
