...
def Get():
	...
	if not auth=="":
		...
		xbmcgui.Dialog().ok('[COLORffff0066][B][I]iSw!tch Streams[/I][/B][/COLOR][COLORfffefe33] .[/COLOR]','[COLORfffefe33]M3U URL: [/COLOR]%s'%shortm3u,'','[COLORfffefe33]EPG URL: [/COLOR]%s'%shortepg)
	else:
		return