...
ini          =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.iswitchstreamslive/resources/ivue','addons_index.ini'))
drxini          =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.iswitchstreamslive/resources/ivue','addons2.ini.ini'))
inizip       = 	xbmc.translatePath(os.path.join('special://home/addons/plugin.video.iswitchstreamslive/resources/ivue','addons_index.zip'))
...
iVueSet = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.iswitchstreamslive/resources/ivue','ivuesettings.xml'))
iVueFold = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.iswitchstreamslive/resources/ivue'))
...
V_drxskin = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/script.ivueguide/resources/skins/iswitchstreamslive'))
...
def iVueInt2():
	...
	xbmc.executebuiltin('RunAddon(plugin.video.iswitchstreamslive)')
	xbmc.executebuiltin("ActivateWindow(busydialog)")
	dp = xbmcgui.DialogProgress()
	dp.create("[COLORffff0066][B][I]iSw!tch Streams[/I][/B][/COLOR][COLORfffefe33] .[/COLOR]","Setting up iVue",'', 'Please Wait')
	...
	dp.create("[COLORffff0066][B][I]iSw!tch Streams[/I][/B][/COLOR][COLORfffefe33] .[/COLOR]","Locating Files",'', 'Please Wait')
	...
	dp.create("[COLORffff0066][B][I]iSw!tch Streams[/I][/B][/COLOR][COLORfffefe33] .[/COLOR]","Adding Information",'', 'Please Wait')
	a = open(V_drxaddons2ini).read()
	b = a.replace('<iswitchstreamsliveUN>',username).replace('<iswitchstreamslivePW>',password)
...
def iVueInt():
	...
	xbmc.executebuiltin("ActivateWindow(busydialog)")
	dp = xbmcgui.DialogProgress()
	dp.create("[COLORffff0066][B][I]iSw!tch Streams[/I][/B][/COLOR][COLORfffefe33] .[/COLOR]","Copying ini",'', 'Please Wait')
...
def amylist_install(name,url):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("[COLORffff0066][B][I]iSw!tch Streams[/I][/B][/COLOR][COLORfffefe33] .[/COLOR]","Installing Channel List...",'', 'Please Wait')
...
def drxskin_install(name,url):
    path = xbmc.translatePath(os.path.join('special://home/addons','packages'))
    dp = xbmcgui.DialogProgress()
    dp.create("[COLORffff0066][B][I]iSw!tch Streams[/I][/B][/COLOR][COLORfffefe33] .[/COLOR]","Installing Skin...",'', 'Please Wait')
    lib=os.path.join(path, 'iswitchstreamslive.zip')
    try:
       os.remove(lib)
    except:
       pass
...
def install(name,url):
    path = xbmc.translatePath(os.path.join('special://home/addons','packages'))
    dp = xbmcgui.DialogProgress()
    dp.create("[COLORffff0066][B][I]iSw!tch Streams[/I][/B][/COLOR][COLORfffefe33] .[/COLOR]","Installing iVue TV Guide...",'', 'Please Wait')
